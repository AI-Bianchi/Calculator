    ...
    render() {
        return (
            <div className="calc-button-row">
                ...
                <button className="button" name="C" onClick={e => this.props.onClick(e.target.name)}>C</button>
                <br/>
                ...
                <button className="button" name="*" onClick={e => this.props.onClick(e.target.name)}>x</button>
                <br/>
